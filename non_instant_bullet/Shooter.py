...
class Shooter:
    ...
    def move(self, env, speed):
        ...
        if okX and self.x + self.speed * math.cos(self.gun.angle) > self.radius and self.x + self.speed * math.cos(self.gun.angle) < 800 - self.radius:
            self.x += self.speed * math.cos(self.gun.angle)
        if okY and self.y + self.speed * math.sin(self.gun.angle) > self.radius and self.y + self.speed * math.sin(self.gun.angle) < 800 - self.radius:
